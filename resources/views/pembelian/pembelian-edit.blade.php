                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <div class="form-login">
                            <form action="{{ url('/pembelian/update/' . $pembelian->id_pembelian) }}" method="post"
