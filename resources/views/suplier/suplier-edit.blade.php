                ...
                <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <div class="form-login">
                            <form action="{{ url('/suplier/update/' . $suplier->id_suplier) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="id_suplier">ID suplier</label>
                                    <input class="form-control" type="text" name="id_suplier" id="id_suplier"
                                        placeholder="Masukkan ID suplier" value="{{ $suplier->id_suplier }}" />
                                </div>
                                <div class="form-group">
                                    <label for="nama">NAMA suplier</label>
                                    <input class="form-control" type="text" name="nama_suplier" id="nama_suplier"
                                        placeholder="Masukkan Nama suplier" value="{{ $suplier->nama_suplier }}" />
                                </div>

                                <div class="form-group">
                                    <label for="no_telpon">NOMOR TELEPON</label>
                                    <input class="form-control" type="text" name="no_telpon" id="no_telpon"
                                        placeholder="Masukkan Nomor Telepon" value="{{ $suplier->no_telpon }}" />
                                </div>
                                <div class="form-group">
                                    <label for="perusahaan">PERUSAHAAN</label>
                                    <input class="form-control" type="text" name="perusahaan" id="perusahaan"
                                        placeholder="Masukkan Perusahaan" value="{{ $suplier->perusahaan }}" />
                                </div>
                                <div class="form-group">
