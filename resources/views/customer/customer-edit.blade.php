                        ...
                        <div class="form-login">
                            <form action="{{ url('/customer/update/' . $customer->id_customer) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="id_customer" id="id_customer"
                                        placeholder="Masukkan ID customer" value="{{ $customer->id_customer }}" />
                                </div>
                                <div class="form-group">
                                    <label for="nama">NAMA customer</label>
                                    <input class="form-control" type="text" name="nama_customer" id="nama_customer"
                                        placeholder="Masukkan Nama customer" value="{{ $customer->nama_customer }}" />
                                </div>
                                <div class="form-group">
                                    <label for="alamat">ALAMAT</label>
                                    <input class="form-control" type="text" name="alamat" id="alamat"
                                        placeholder="Masukkan Alamat" value="{{ $customer->alamat }}" />
                                </div>
                                <div class="form-group">
                                    <label for="no_telpon">NOMOR TELEPON</label>
                                    <input class="form-control" type="text" name="no_telpon" id="no_telpon"
                                        placeholder="Masukkan Nomor Telepon" value="{{ $customer->no_telpon }}" />
                                </div>
                                <div class="form-group">
