...
<head>
    ...
    <link href="{{asset('Template/style/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
                    ...
                    <div class="content">
                        ...
                        <div class="form-login">
                            <form action="{{ url('/penjualan/update/' . $penjualan->id_penjualan) }}" method="post"
                                ...
                                <div class="form-group">
                                <label for="id_customer">PILIH ID CUSTOMER</label>
                                <select class="form-control" name="id_customer" id="id_customer" >
                                    <option value="{{ $penjualan->id_customer }}">Pilih ID CUSTOMER</option>
                                    <?php
// Koneksi ke database (ganti dengan konfigurasi koneksi Anda)
$koneksi = mysqli_connect("localhost", "root", "", "sipenjualan_tokovelg");
...
$query = "SELECT id_customer, id_customer FROM customer";
